                    ...
                    <Container className="relative h-full">
                        <div className="absolute left-1/2 top-1/2 w-[90%] max-w-[820px] -translate-x-1/2 -translate-y-1/2 text-center">
                            <h1
                                ...
                                className={`font-stamp font-normal tracking-brand text-[28px] leading-[34px] lg:text-[48px] lg:leading-[52px] text-taiky-orange uppercase ${riseClass}`}
                            >
                                {title}
                            </h1>
                            {s1?.content ? (
                                <div
                                    ...
                                    className={`mt-[16px] lg:mt-[30px] font-semibold text-[15px] leading-[24px] lg:text-[20px] lg:leading-[32px] text-taiky-lightbrown uppercase [&_b]:font-bold [&_b]:text-taiky-brown ${riseClass}`}
